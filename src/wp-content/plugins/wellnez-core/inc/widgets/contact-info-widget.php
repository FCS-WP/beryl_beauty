...
class wellnez_contact_info_widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			// Base ID of your widget
			'wellnez_contact_info_widget',
			// Widget name will appear in UI
			esc_html__( 'Wellnez :: Contact Info', 'wellnez' ),
			// Widget description
			array(
				'description'	 => esc_html__( 'Add Contact Info', 'wellnez' ),
...
public function form( $instance ) {
	...
	if ( isset( $instance[ 'title' ] ) ) {
		...
		$title = esc_html__( 'Contect Us', 'wellnez' );
	}
...
function wellnez_contact_info_load_widget() {
	register_widget( 'wellnez_contact_info_widget' );
}
add_action( 'widgets_init', 'wellnez_contact_info_load_widget' );