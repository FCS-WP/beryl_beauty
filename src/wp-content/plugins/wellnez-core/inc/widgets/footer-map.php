...
class wellnez_map_widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			// Base ID of your widget
			'wellnez_map_widget',
			// Widget name will appear in UI
			esc_html__( 'Wellnez :: Map', 'wellnez' ),
			// Widget description
			array(
				'description'	 => esc_html__( 'Add Map', 'wellnez' ),
				'classname'		 => '',
			)
		);
	}
...
public function form( $instance ) {
	...
	if ( isset( $instance[ 'title' ] ) ) {
		...
		$title = esc_html__( 'Get Direction', 'wellnez' );
	}
...
function wellnez_map_load_widget() {
	register_widget( 'wellnez_map_widget' );
}
add_action( 'widgets_init', 'wellnez_map_load_widget' );