...
class wellnez_recent_posts_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'wellnez_recent_posts_widget',

                // Widget name will appear in UI
                esc_html__( 'Wellnez :: Recent Posts', 'wellnez' ),
                                ...
                                echo '<div class="media-body">';
                                    ...
                                    if( $show_date ){
                                        echo '<div class="recent-post-meta">';
                                            echo '<a href="'.esc_url( wellnez_blog_date_permalink() ).'"><i class="fas fa-calendar-alt"></i>'.esc_html( get_the_time( 'd F Y' ) ).'</a>';
                                        echo '</div>';
                                    }
                                echo '</div>';
                        echo '</div>';
    ...
    } // Class wellnez_recent_posts_widget ends here


    // Register and load the widget
    function wellnez_recent_posts_load_widget() {
        register_widget( 'wellnez_recent_posts_widget' );
    }
    add_action( 'widgets_init', 'wellnez_recent_posts_load_widget' );