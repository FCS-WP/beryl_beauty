 ...
 *
 */
class Wellnez_New_Header extends Widget_Base {

	public function get_name() {
		return 'wellneznewheader';
	}

	public function get_title() {
		return __( 'Wellnez Header', 'wellnez' );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
			'login_text',
			[
				'label' 	=> __( 'Login text', 'wellnez' ),
                'type' 		=> Controls_Manager::TEXTAREA,
                'default'  	=> __( 'Login', 'wellnez' )
			]
        );
        ...
        $this->add_control(
            'login_text_link',
            [
                'label' 		=> __( 'Login Text Link', 'wellnez' ),
                'type' 			=> Controls_Manager::URL,
                'placeholder' 	=> __( 'https://your-link.com', 'wellnez' ),
                'show_external' => true,
                'default' 		=> [
        ...
        $this->add_control(
			'register_text',
			[
				'label' 	=> __( 'Register text', 'wellnez' ),
                'type' 		=> Controls_Manager::TEXTAREA,
                'default'  	=> __( 'Register', 'wellnez' )
			]
        );
        ...
        $this->add_control(
            'register_text_link',
            [
                'label' 		=> __( 'Register Text Link', 'wellnez' ),
                'type' 			=> Controls_Manager::URL,
                'placeholder' 	=> __( 'https://your-link.com', 'wellnez' ),
                'show_external' => true,
                'default' 		=> [
