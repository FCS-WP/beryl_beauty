...
class mixlax_filter_categories_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'mixlax_filter_categories_widget',

                // Widget name will appear in UI
                esc_html__( 'Mixlax :: Product Categories Filter', 'mixlax' ),

                // Widget description
                array(
                    'classname'   => 'widget_product_categories',
                    'customize_selective_refresh' => true,
                    'description' => esc_html__( 'Add Product Categories Filter Widget', 'mixlax' ),
                )
            );
        }
    ...
    } // Class mixlax_filter_categories_widget ends here


    // Register and load the widget
    function mixlax_filter_categories_load_widget() {
        register_widget( 'mixlax_filter_categories_widget' );
    }
    add_action( 'widgets_init', 'mixlax_filter_categories_load_widget' );
