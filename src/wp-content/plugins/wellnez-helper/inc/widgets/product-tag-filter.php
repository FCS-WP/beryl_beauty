...
class mixlax_filter_tags_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'mixlax_filter_tags_widget',

                // Widget name will appear in UI
                esc_html__( 'Mixlax :: Product Tags Filter', 'mixlax' ),

                // Widget description
                array(
                    'classname'   => 'widget_tag_cloud',
                    'customize_selective_refresh' => true,
                    'description' => esc_html__( 'Add Product Tags Filter Widget', 'mixlax' ),
                )
            );
        }
    ...
    } // Class mixlax_filter_tags_widget ends here


    // Register and load the widget
    function mixlax_filter_tags_load_widget() {
        register_widget( 'mixlax_filter_tags_widget' );
    }
    add_action( 'widgets_init', 'mixlax_filter_tags_load_widget' );
