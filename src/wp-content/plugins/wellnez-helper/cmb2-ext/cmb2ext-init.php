...
// Cmb 2 Admin Script
add_action( 'admin_enqueue_scripts', 'mixlax_cmb2_admin_scripts' );
function mixlax_cmb2_admin_scripts( $screen ){

    // CMB2
	wp_enqueue_style( 'metafield-style', plugins_url( 'css/custom.metafield.css', __FILE__ ) , array(), '1.0' );
	
    wp_enqueue_script('mixlax-metafield-switch',plugins_url( 'js/switcher.metafield.js', __FILE__ ) , array('jquery'), '1.0', true );
...
// Switch Field 
require_once ( MIXLAX_PLUGIN_CMB2EXT_PATH.'switch_metafield.php');
require_once ( MIXLAX_PLUGIN_CMB2EXT_PATH.'cmb2-fontawesome-picker.php');