 ...
 *
 */
class Mixlax_Google_Map extends Widget_Base {

	public function get_name() {
		return 'mixlaxgooglemap';
	}

	public function get_title() {
		return __( 'Google Map', 'mixlax' );
	}
